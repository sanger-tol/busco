...
## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/busco/usage](https://nf-co.re/busco/usage)
...
```bash
nextflow run sanger-tol/busco --input ./samplesheet.csv --outdir ./results --genome GRCh37 -profile docker
```
