...
## [[0.3.2](https://github.com/sanger-tol/busco/releases/tag/0.3.2)] – Lincolnshire (patch 2) – [2026-08-26]
...
- Completed the documentation of the pipeline.
- Fixed the MultiQC output.
